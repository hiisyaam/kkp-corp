            ...
            <div class="bg-[#1c1c1c]/80 backdrop-blur-xl border border-white/10 rounded-[2rem] p-8 sm:p-10 shadow-2xl relative overflow-hidden group hover:border-kkpBlue/30 transition-all duration-500">
                ...
                <div class="text-center mb-8">
                    <div class="inline-flex items-center justify-center w-16 h-16 bg-white/5 border border-white/10 rounded-2xl text-kkpBlue mb-4 shadow-inner">
                        <span class="material-icons-round text-3xl">login</span>
                    </div>
                ...
                <form action="#" method="POST" class="space-y-5">
                    ...
                    <div class="space-y-1 relative">
                        <label class="block font-sans text-[11px] text-gray-400 uppercase tracking-widest font-bold ml-1">Email / Username</label>
                        <div class="flex items-center bg-[#222222] rounded-xl p-3 border border-white/5 focus-within:border-kkpBlue transition-all">
                            <span class="material-icons-round text-gray-500 mr-3">person</span>
                            <input type="text" placeholder="Masukkan email atau username" class="w-full bg-transparent border-0 outline-none focus:outline-none focus:ring-0 text-white placeholder-gray-600 font-inter text-sm" required />
                        </div>
                    </div>
                    ...
                    <div class="space-y-1 relative">
                        ...
                        <div class="flex items-center bg-[#222222] rounded-xl p-3 border border-white/5 focus-within:border-kkpBlue transition-all">
                            <span class="material-icons-round text-gray-500 mr-3">lock</span>
                            <input type="password" placeholder="Masukkan password Anda" class="w-full bg-transparent border-0 outline-none focus:outline-none focus:ring-0 text-white placeholder-gray-600 font-inter text-sm" required />
                            <button type="button" class="text-gray-500 hover:text-white transition-colors focus:outline-none ml-2">
                    ...
                    <div class="flex items-center justify-between pt-1">
                        <label class="flex items-center cursor-pointer group">
                            <input type="checkbox" class="w-4 h-4 rounded border-gray-600 bg-[#222222] text-kkpBlue focus:ring-kkpBlue/50 cursor-pointer">
                            <span class="ml-2 text-xs sm:text-sm text-gray-400 font-inter group-hover:text-white transition-colors">Ingat Saya</span>
                        </label>
                        <a href="#" class="text-xs sm:text-sm font-bold text-kkpBlue hover:text-white transition-colors font-sans">Lupa Password?</a>
                    </div>

                    <button type="submit" class="w-full bg-kkpBlue text-kkpDark py-3.5 rounded-xl font-bold hover:bg-white hover:-translate-y-0.5 transition-all duration-300 shadow-[0_10px_20px_rgba(140,201,233,0.2)] mt-4">
                        Masuk
                    </button>
                </form>
                ...
                <div class="mt-8 text-center border-t border-white/10 pt-6">
                    <p class="text-xs sm:text-sm text-gray-400 font-inter">
                        ...
                        <a href="/register" class="font-bold text-white hover:text-kkpBlue transition-colors font-sans uppercase tracking-wide ml-1">Daftar Sekarang</a>
                    </p>
                </div>
